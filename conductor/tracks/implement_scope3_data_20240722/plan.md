...
- [x] Task: Define detailed data points and emission factors for selected Scope 3 categories
...
- [x] Task: Update database schema for new Scope 3 data
    ...
    - [x] Sub-task: Add tables/columns for Purchased Goods & Services data
- [x] Task: Implement Python calculation logic for new Scope 3 categories
